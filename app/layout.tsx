...
export const metadata = {
  metadataBase: new URL('https://www.suppamascamp.me'),
  title: 'ค่ายลูกเสืออนุสรณ์ศุภมาศ อำเภอโพธาราม จังหวัดราชบุรี',
  description: 'สถานที่จัดกิจกรรมอยู่ค่ายพักแรมลูกเสือ,เนตรนารี,ยุวกาชาด ตั้งอยู่ขอบเขตระหว่างจังหวัดราชบุรีและกาญจนบุรี ในราคามิตรภาพ พร้อมวิทยากรลูกเสือมืออาชีพ',
